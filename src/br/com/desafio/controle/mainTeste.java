...
public class mainTeste {
    public static void main(String[] args) {
        ...
        Conta conta = new ContaCorente(cliente);

        String recebeCPF = getString("Digite seu CPF: ");
        cliente = clienteRepositorio.ler(recebeCPF);
        System.out.println(clienteRepositorio.contains(clienteRepositorio.ler(recebeCPF)));
        System.out.println(conta.getCliente().getCpf().equals(cliente));
//
